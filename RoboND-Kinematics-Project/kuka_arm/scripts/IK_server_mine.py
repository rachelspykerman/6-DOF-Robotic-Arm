...
#            theta1 = atan2(wy, wx)
            ...
            # theta2
         #   s1 = WC[0] - a1		mine
            s1 = sqrt(WC[0]**2 + WC[1]**2) - a1
            s2 = WC[2] - d1
            beta1 = atan2(s2, s1)
            s3 = sqrt(s1**2 + s2**2)
            s4 = sqrt(d4**2 + a3**2)
#            beta2 = acos((a2**2 + s3**2 - s4**2)/(2*a2*s3))
            beta2 = acos((a2**2 + s1**2 - s4**2)/(2*a2*s1))
#            D2 = (a2**2 + s3**2 - s4**2)/(2*a2*s3)
#            beta2 = atan2(sqrt(1 - D2**2), D2)
            theta2 = (pi/2) - beta2 - beta1

            # theta3
#            beta3 = acos((s4**2 + a2**2 - s3**2)/(2*a2*s4))	mine
            D3 = (d4**2 + a2**2 - s1**2)/(2*a2*d4)
            beta3 = atan2(D3, sqrt(1 - D3**2))
#            beta4 = atan2(a3, d4)		mine
#            beta4 = atan2(-a3, d4)
#            theta3 = (pi/2) - beta4 - beta3 	mine
            theta3 = (pi/2) - beta3
